...
public class DrawablePath implements Drawable<DrawablePath> {
	...
	public JSONObject toJSON() {
		...
		LinkedList segmentsListJSON = new LinkedList();
		for (DrawableSegment segment : this.segmentsList) {
			segmentsListJSON.add(segment);
		}
		m.put("segmentsList", segmentsListJSON);
		j.putAll(m);
		return j;
	};
